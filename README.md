...
**Текущая версия: v6.4.0** 🚀

## 📋 История версий

### v6.4.0 (текущая) - Полная детализация платежей
...
**Версия:** v6.4.0 (полная детализация по стандартам ЖКХ РФ)  
**Дата:** 2025-12-06  
**Статус:** ✅ Полностью соответствует структуре реальных квитанций ЖКХ  
